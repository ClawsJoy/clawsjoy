...
def get_skills_stats():
    """获取技能统计"""
    categories = {}
    for skill_name in skill_loader.list_all():
        # 简单分类
    ...
    return jsonify({"total": len(skill_loader.list_all()), "by_category": categories})
    ...
    return jsonify(
        {
            ...
            "skills": {
                "total": len(skill_loader.list_all()),
...
if __name__ == "__main__":
    port = smart_config.PORTS.get("web_registry", 5022)
