...
def token_required(f):
    ...
    def decorated(*args, **kwargs):
        ...
        try:
            resp = requests.get(f"{AUTH_SERVICE}/auth/verify",
...
def services_status():
    """所有服务状态"""
    services = [
        {"name": "auth_service", "port": 5444, "url": "https://localhost:5444/auth/verify"},
        {"name": "driver_service", "port": 5443, "url": "https://localhost:5443/health"},
        {"name": "preference_service", "port": 5445, "url": "https://localhost:5445/"},
        {"name": "ollama", "port": 11434, "url": "config_loader.get_ollama_url()/api/tags"},
...
if __name__ == '__main__':
    ...
    print("=" * 50)
    app.run(host='0.0.0.0', port=5446, debug=False, ssl_context=('ssl/cert.pem', 'ssl/key.pem'))
