...
from lightx2v.models.networks.wan.infer.matrix_game2.transformer_infer import (
    WanMtxg2TransformerInfer,
)
from lightx2v.models.networks.wan.infer.post_infer import WanPostInfer
from lightx2v.models.networks.wan.sf_model import WanSFModel
from lightx2v.models.networks.wan.weights.matrix_game2.pre_weights import (
    WanMtxg2PreWeights,
)
from lightx2v.models.networks.wan.weights.matrix_game2.transformer_weights import (
...
class WanSFMtxg2Model(WanSFModel):
    ...
    def _load_ckpt(self, unified_dtype, sensitive_layer):
        file_path = os.path.join(
            ...
            f"{self.config['sub_model_folder']}/{self.config['sub_model_name']}",
        )
        _weight_dict = self._load_safetensor_to_dict(
