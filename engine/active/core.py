...
from typing import Any, Dict, List, Optional, Tuple,  Any, Dict, List, Optional, Tuple,  Any, Dict, List, Optional,  List, Dict, Any, Optional,  Dict, Any, Tuple, Optional
...
class ActiveEngine:
    ...
    def should_ask(self, query: str, intent: str, confidence: float) -> Tuple[bool, Optional[Any]]:
        """判断是否需要主动询问"""
        if confidence < 0.5:
