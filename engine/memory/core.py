...
from typing import Any, Dict, List, Optional, Tuple,  Any, Dict, List, Optional, Tuple,  Any, Dict, List, Optional,  List, Dict, Any, Optional,  Dict, Any, Optional
...
class MemoryEngine:
    ...
    def process(self, input_data: Any, **kwargs) -> Any:
        ...
        if isinstance(input_data, dict):
            ...
            if action == 'remember':
                return self.remember(input_data.get('key'), input_data.get('value'), kwargs.get('user_id', 'default'))
            else:
                return self.recall(input_data.get('key'), kwargs.get('user_id', 'default'))
