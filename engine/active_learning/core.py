...
class ActiveLearningEngine:
    ...
    def request_label(self, query: str, predicted_intent: str, confidence: float, reason: str = "") -> Dict:
        request = {
    ...
    def get_stats(self) -> Dict:
        return {
            "pending_requests": len([r for r in self.pending_requests if r['status'] == 'pending']),
