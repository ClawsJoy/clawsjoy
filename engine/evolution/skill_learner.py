...
class SkillIncrementalLearner:
    ...
    def __init__(self):
        self.usage_stats = defaultdict(lambda: {"count": 0, "success": 0, "last_used": None})
    ...
    def get_stats(self) -> Dict:
        return {
            ...
            "avg_success_rate": sum(s['success']/s['count'] for s in self.usage_stats.values() if s['count']>0) / len(self.usage_stats) if self.usage_stats else 0
        }
