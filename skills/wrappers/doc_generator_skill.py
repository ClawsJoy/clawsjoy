...
class DocGeneratorSkill(BaseSkill):
    ...
    def _create_docx(self, params):
        resp = requests.post("http://smart_config.HOST:5007/docx", json={
    ...
    def _create_excel(self, params):
        resp = requests.post("http://smart_config.HOST:5007/excel", json={
    ...
    def _create_ppt(self, params):
        resp = requests.post("http://smart_config.HOST:5007/ppt", json={
    ...
    def _create_md(self, params):
        resp = requests.post("http://smart_config.HOST:5007/md", json={
            "title": params.get("title", "文档"),
            "content": params.get("content", "")
        })
        return resp.json()
