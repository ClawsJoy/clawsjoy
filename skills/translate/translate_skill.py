...
class TranslateSkill:
    ...
    def execute(self, goal=None, params=None, **kwargs):
        ...
        if not text:
            return {"success": False, "error": "请提供要翻译的文本", "response": "翻译失败"}
        ...
        local_map = {
            ...
            "hi": "你好", "how are you": "你好吗", "i love you": "我爱你"
        }
        
        lower_content = content.lower()
        if lower_content in local_map:
            return {"success": True, "result": local_map[lower_content], "response": local_map[lower_content], "source": "local"}
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                result = result.strip()
                if result:
                    return {"success": True, "result": result, "response": result, "source": "ollama"}
        except Exception as e:
            print(f"Ollama 翻译失败: {e}")
        
        return {"success": True, "result": content, "response": content, "source": "fallback"}
