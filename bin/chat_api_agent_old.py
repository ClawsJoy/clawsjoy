...
class AgentHandler(BaseHTTPRequestHandler):
    ...
    def _is_promo(self, text):
        patterns = [r'(制作|生成|做).{0,3}(宣传片|宣傳片)', r'生产片', r'產片', r'宣傳', r'promo']
        for p in patterns:
    ...
    def _handle_agent(self):
        try:
            ...
            # 照片查询
            if any(k in user_input for k in ['照片', '图片', '相册', '我的照片', 'photo', 'picture']):
            ...
            if reply:
                ...
                default_msg = '你好！有什么可以帮你的？' if lang == 'zh' else 'Hello! How can I help you?'
