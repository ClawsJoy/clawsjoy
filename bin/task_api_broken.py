...
class TaskHandler(BaseHTTPRequestHandler):
    ...
    def _handle_library_upload(self):
        ...
        self.send_json({'success': True, 'file_id': file_id, 'original_name': uploaded_file.filename, 'type': category, 'size': size})
...
if __name__ == '__main__':
    ...
    print("  POST /api/task/promo - 提交宣传片任务（个人图片优先）")
