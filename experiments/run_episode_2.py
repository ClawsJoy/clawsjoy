...
# 1. 读取 Workspace 配置
workspace = Path("str(smart_config.ROOT)/experiments/youtube_series/workspace")
...
(
    ...
    else log_file.write_text(
        log_file.read_text(encoding="utf-8") + log_entry, encoding="utf-8"
    )
)
