...
from core.lib.memory_optimization_config import memory_opt_config


class VectorMemory:
    def __init__(self, persist_dir=f"{get_data_root()}/vector_kb", collection_name="memory_vectors"):
