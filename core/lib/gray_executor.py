...
class GrayExecutor:
    ...
    def should_use_gray(self, suggestion: str, risk_level: str) -> bool:
        ...
        if not self.enabled:
            return False
        gray_levels = closed_loop_config.get('execution.gray_execute_levels', ['medium'])
    ...
    def get_status(self) -> Dict:
        ...
        return {
            ...
            "success_rate": sum(1 for s in self._samples if s.get('success')) / max(1, len(self._samples))
        }
