...
class SkillRegistry:
    ...
    def __init__(self, registry_file="data/skill_manifests.json"):
    ...
    def register_atomic(self, name: str, description: str, category: str,
    ...
    def register_workflow(self, name: str, description: str, steps: List[Dict],
                          dependencies: List[str] = None, tags: List[str] = None) -> bool:
        """注册工作流技能"""
        import datetime
        manifest = SkillManifest(
            name=name,
    ...
    def update_success_rate(self, name: str, success: bool):
        ...
        if manifest:
            ...
            # 移动平均更新成功率
            manifest.success_rate = (current_rate * (total - 1) + (100 if success else 0)) / total
            self._save()
