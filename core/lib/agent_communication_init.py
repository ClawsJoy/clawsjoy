...
AGENT_TOPICS = {
    ...
    "decision_agent": [
        "task.decision",
        "task.decision.optimize",
        "task.decision.schedule",
    ],
    "youtube_agent": [
        "task.youtube",
        "task.youtube.upload",
        "task.youtube.analyze",
        "task.youtube.optimize",
    ],
