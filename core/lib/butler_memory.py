...
class ButlerMemory:
    def __init__(self, user_id: str):
        ...
        base_path = unified_config.get("butler.paths.user_data", unified_config.get("paths.users_dir", f"{get_data_root()}/users/") + "/{user_id}/butler_v2")
        ...
        self.vector_collection = self.vector_client.get_or_create_collection("butler_memory")
    # ... 其余代码保持不变
