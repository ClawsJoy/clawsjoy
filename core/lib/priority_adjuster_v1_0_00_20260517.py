...
class PriorityAdjuster:
    ...
    def adjust_priority(self, task_name: str, current_priority: int, 
    ...
    def get_stats(self) -> Dict:
        ...
        return {
            ...
            "high_success_tasks": sum(1 for h in self.history.values() if h.get('success', 0) > h.get('fail', 0)),
            "high_fail_tasks": sum(1 for h in self.history.values() if h.get('fail', 0) > h.get('success', 0))
        }
