...
class UnifiedConfig:
    ...
    def _load(self):
        # 项目根目录
        self.ROOT = Path(os.environ.get('CLAWSJOY_ROOT', 'str(smart_config.ROOT)'))
        ...
        # LLM 配置
        self.LLM = {
            'ollama_endpoint': os.environ.get('OLLAMA_HOST', 'http://smart_config.HOST:str(smart_config.get_port("ollama"))'),
