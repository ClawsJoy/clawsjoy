...
sys.path.insert(0, 'str(smart_config.ROOT)/agents')
try:
...
OLLAMA_API = "http://smart_config.HOST:str(smart_config.get_port("ollama"))/api/generate"
OLLAMA_MODEL = "qwen2.5:3b"

def search_keywords(query):
    try:
        resp = requests.post("http://smart_config.HOST:7700/indexes/keywords/search",
