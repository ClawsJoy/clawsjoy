...
workflows_dir = Path("str(smart_config.ROOT)/workflows")
output_dir = Path("str(smart_config.ROOT)/data/n8n/import")
...
for wf_file in workflows_dir.glob("*.json"):
    ...
    for step in wf.get("steps", []):
        node = {
            ...
            "position": [0, 0],
            "parameters": {
                "url": f"http://smart_config.HOST:8108/api/promo/make",
                "method": "POST",
