...
class VectorMemory:
    ...
    def __init__(self, user_id: str):
        ...
        self.base_path = Path(f"{config_helper.get_data_root()}/vectors/{user_id}")
    ...
    def _get_embedding(self, text: str) -> np.ndarray:
        ...
        try:
            response = requests.post(
                ...
                json={"model": config_helper.get_embedding_model(), "prompt": text},
...
# 便捷函数
def get_vector_memory(user_id: str) -> VectorMemory:
