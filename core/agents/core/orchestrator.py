...
class TaskOrchestrator:
    def __init__(self):
        ...
        self.meilisearch = "http://smart_config.HOST:7700"
    ...
    def _call_promo_api(self, params):
        ...
        try:
            resp = requests.post("http://smart_config.HOST:8108/api/promo/make",
    ...
    def _search_qdrant(self, params):
        ...
        try:
            resp = requests.post("http://smart_config.HOST:6333/collections/kb_tenant_1/points/search",
