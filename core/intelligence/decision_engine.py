...
class DecisionEngineV4:
    ...
    def __init__(self):
        ...
        self.ollama_model = unified_config.get(
            "llm.default_model",
            unified_config.get("llm.default_model", get_llm_model()),
        )
    ...
    def _load_rules(self):
        ...
        return unified_config.get(
            "decision",
            {"sleep_interval": 0.5, "max_queue_size": 100, "auto_execute": True},
        )
    ...
    def decide(self, context: dict) -> dict:
        ...
        if task_type == "math":
            return {
                "action": "use_math_model",
                "model": unified_config.get("llm.fast_model", get_llm_model(fast=True)),
            }
        elif task_type == "code":
            return {
                "action": "use_code_model",
                "model": unified_config.get("llm.models.code", "deepseek-coder:6.7b"),
            }
        elif task_type == "creative":
            return {
                "action": "use_creative_model",
                "model": unified_config.get("llm.default_model", get_llm_model()),
            }
        else:
    ...
    def _predict_performance(self) -> Dict:
        ...
        try:
            ...
            return (
                ...
                if hasattr(predictor, "get_prediction")
                else {}
            )
