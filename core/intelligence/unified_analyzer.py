...
class UnifiedAnalyzer:
    ...
    def _load_config(self):
        ...
        if config_file.exists():
            ...
            self.config = {
                ...
                "llm": {"model": unified_config.get_llm_config().get("default_model", unified_config.get_llm_config().get("default_model", config_helper.get_llm_model())), "temperature": 0.3, "max_tokens": 2000},
    ...
    def analyze(self) -> Dict:
        ...
        try:
            ...
            print(f"📤 分析结果已发送给决策者, 健康度: {result['summary']['health_score']}")
