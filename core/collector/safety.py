...
class SafetyChecker:
    ...
    # 敏感域名黑名单
    BLACKLIST_DOMAINS = [
        'weibo.com', 'weixin.com', 'qq.com',  # 社交平台
        'baidu.com', 'google.com',            # 搜索引擎
        'taobao.com', 'jd.com',               # 电商
        'douyin.com', 'kuaishou.com',         # 短视频
    ]
    ...
    def load_whitelist(cls) -> List[str]:
        ...
        return [
            'info.gov.hk', 'edb.gov.hk', 'immd.gov.hk',  # 香港政府
            'labour.gov.hk', 'ha.org.hk',                 # 公共服务
        ]
