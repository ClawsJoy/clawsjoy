...
class MultimodalPerception:
    ...
    def perceive_network(self):
        ...
        # 检查关键服务
        services = {
            "ollama": "http://smart_config.HOST:str(smart_config.get_port("ollama"))/api/tags",
            "gateway": "http://smart_config.HOST:str(smart_config.get_port("gateway"))/api/health",
            "fileservice": "http://smart_config.HOST:5003/health",
            "multiagent": "http://smart_config.HOST:5006/health"
        }
