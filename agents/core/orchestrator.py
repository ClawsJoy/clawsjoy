...
class TaskOrchestrator:
    ...
    def _load_skill_index(self):
        with open("/mnt/d/clawsjoy/data/skill_keywords.json") as f:
            return json.load(f)
    ...
    def _call_youtube_upload(self, params):
        ...
        result = subprocess.run(
            ["python3", "/mnt/d/clawsjoy/agents/youtube_uploader.py", "--tenant", "tenant_1"],
    ...
    def _save_webhook(self, params):
        ...
        config_file = Path("/mnt/d/clawsjoy/tenants/tenant_1/agent_config.json")
